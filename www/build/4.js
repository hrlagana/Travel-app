...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__event_list__ = __webpack_require__(509);
...
var EventListPage = (function () {
    ...
    EventListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: "page-event-list",template:/*ion-inline-start:"C:\Users\Christos\Desktop\trvlpl\src\pages\event-list\event-list.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>EventList</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-list>\n    <ion-item *ngFor="let event of eventList" (click)="goToEventDetail(event.id)">\n      <h2>{{event?.name}}</h2>\n      <p>Ticket:\n        <strong>${{event?.price}}</strong>\n      </p>\n      <p>Date:\n        <strong>{{event?.date}}</strong>\n      </p>\n    </ion-item>\n  </ion-list>\n</ion-content>'/*ion-inline-end:"C:\Users\Christos\Desktop\trvlpl\src\pages\event-list\event-list.html"*/
        }),
